	...
	var tacgUtils = {
		setJobPG: function (classPG) {
			...
			case 'warrior':
				...
				break;
			case 'sura':
				job1.innerHTML = 'سلاح سحري';
				job1.setAttribute('value','mirage');
				job2.innerHTML = 'سحر أسود';
				job2.setAttribute('value','blackmagic');
				break;
			case 'ninja':
				job1.innerHTML = 'قتال عن قرب';
				job1.setAttribute('value','bladefight');
				job2.innerHTML = 'قتال عن بعد';
			...
			case 'shaman':
				...
				break;
			case 'Lycan':
					job1.innerHTML = 'روح الذئب';
					job1.setAttribute('value','Wolf Soul');
					job2.innerHTML = 'لايوجد تخصص ثاني';
					job2.setAttribute('value','value');
					break;
		...
		updateAuraAndFrenzy: function (classPG,jobPG) {
			...
			case 'sura':
				if(jobPG === 'mirage') {
					aurath.innerHTML = 'مستوى الشفرة المسحورة';
					aurath.style.visibility = 'visible';	
					auratd.style.visibility = 'visible';	
				} else {
					aurath.style.visibility = 'hidden';	
			...
			case 'Lycan':
					if(jobPG === 'Wolf Soul') {
						aurath.innerHTML = 'روح الذئب الكرزي';
						aurath.style.visibility = 'visible';	
						auratd.style.visibility = 'visible';
					} else {
						aurath.style.visibility = 'hidden';	
